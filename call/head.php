...
function show_link() {
	...
	$page[ $i ][ "Link" ] = "/kiccc/voucher/call/index.php";
	
	$i++;
	$page[ $i ][ "Name" ] = "فروش";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/call/sales.php";

	$i++;
	$page[ $i ][ "Name" ] = "جستجو";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/call/find.php";
	
		$i++;
	$page[ $i ][ "Name" ] = "جستجو2";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/call/find2.php";


	$i++;
	$page[ $i ][ "Name" ] = "گروه ها";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/call/groups.php";

	$i++;
	$page[ $i ][ "Name" ] = "وقایع";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/call/logs.php";

	$i++;
	$page[ $i ][ "Name" ] = "گزارش ساعتی";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/call/days.php";


	$i++;
	$page[ $i ][ "Name" ] = "نمایندگیها";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/call/vgroups.php";

	$i++;
	$page[ $i ][ "Name" ] = "گزارش";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/call/repFinalsPin.php";

	$i++;
	$page[ $i ][ "Name" ] = "فروشگاه فعال";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/call/active_report.php";

    $i++;
	$page[ $i ][ "Name" ] = "تغییر مبلغ";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/call/prices_view_only.php";  
