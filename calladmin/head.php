...
function show_link() {
	...
	$page[ $i ][ "Link" ] = "/kiccc/voucher/calladmin/index.php";
	
	$i++;
	$page[ $i ][ "Name" ] = "فروش";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/calladmin/sales.php";

	$i++;
	$page[ $i ][ "Name" ] = "جستجو";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/calladmin/find.php";
	
	$i++;
	$page[ $i ][ "Name" ] = "2جستجو";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/calladmin/find2.php";
	...
	$page[ $i ][ "Link" ] = "/kiccc/voucher/calladmin/get_pin.php";
		...
		$i++;
	$page[ $i ][ "Name" ] = "2مشاهده رمز";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/calladmin/get_pin2.php";

	$i++;
	$page[ $i ][ "Name" ] = "گروه ها";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/calladmin/groups.php";

	$i++;
	$page[ $i ][ "Name" ] = "وقایع";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/calladmin/logs.php";

	$i++;
	$page[ $i ][ "Name" ] = "گزارش ساعتی";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/calladmin/days.php";

       $i++;
	$page[ $i ][ "Name" ] = "وارد کردن پین";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/calladmin/insert_pin.php";

	$i++;
	$page[ $i ][ "Name" ] = "نمایندگیها";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/calladmin/vgroups.php";

	$i++;
	$page[ $i ][ "Name" ] = "گزارش";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/calladmin/repFinalsPin.php";

	$i++;
	$page[ $i ][ "Name" ] = "فروشگاه فعال";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/calladmin/active_report.php";

    $i++;
	$page[ $i ][ "Name" ] = "تغییر مبلغ";
	$page[ $i ][ "Link" ] = "/kiccc/voucher/calladmin/prices_view_only.php";  
